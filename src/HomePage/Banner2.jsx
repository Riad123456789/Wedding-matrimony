  ...
  return (
    <>
      <style>{`
        ...
        .smooth-zoom {
          animation: smooth-zoom 20s infinite alternate;
        }
      `}</style>
          ...
          {images.map((img, index) => (
            <SwiperSlide key={index}>
              <div className='relative w-full h-full '>
                ...
                {/* Content Container */}
                <div className='absolute inset-0 flex flex-col justify-center items-center text-center text-white px-4 pb-20'>
